        ...
        <div ref={containerRef} className="pb-20"> {/* pb-20 prevents content hiding under footer */}
            ...
            <section ref={heroRef} onMouseMove={(e) => setMousePosition({ x: e.clientX, y: e.clientY })} className="relative h-[100dvh] w-full flex items-end pb-20 px-4 md:px-20 pt-32">
                ...
                <div className="relative z-10 w-full md:w-2/3">
                    ...
                    <div className="hero-anim">
                        ...
                        >
                            <span className="flex items-center gap-2">Book an AI Systems Diagnostic <ArrowRight size={24} className="shrink-0" /></span>
                        </MagneticButton>
                    </div>
                </div>
            </section>
            ...
            <section className="py-32 px-4 md:px-20 relative z-10 bg-gray-200 text-gray-900">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-gray-100 border border-gray-300 rounded-[2rem] p-8 h-[400px] flex flex-col justify-between relative overflow-hidden group shadow-sm hover:shadow-md transition-shadow">
                        <h3 className="font-sans text-2xl font-bold text-gray-900">AI Systems Built in <span className="text-accent underline decoration-4 underline-offset-4 decoration-accent/30">7–14 Days</span></h3>
                        <div className="relative h-48 w-full mt-8">
                            <div className="absolute w-[80%] h-32 bg-gray-50 border border-gray-200 rounded-2xl p-4 top-0 left-[10%] shadow-xl transition-transform group-hover:-translate-y-4 duration-500 ease-out z-30 font-bold text-sm text-gray-800">WhatsApp Lead Responder</div>
                            <div className="absolute w-[80%] h-32 bg-gray-100 border border-gray-200 rounded-2xl p-4 top-6 left-[10%] scale-95 opacity-80 z-20 font-bold text-sm text-gray-700">Lead Qualification Bot</div>
                            <div className="absolute w-[80%] h-32 bg-gray-300 border border-gray-400 rounded-2xl p-4 top-12 left-[10%] scale-90 opacity-40 z-10 font-bold text-sm text-gray-600">AI Content System</div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-100 border border-gray-300 rounded-[2rem] p-8 h-[400px] flex flex-col justify-between shadow-sm hover:shadow-md transition-shadow">
                        <h3 className="font-sans text-2xl font-bold text-gray-900">Save 10–30 Hours Per Week</h3>
                        <div className="bg-gray-200 rounded-2xl p-6 font-mono text-sm text-gray-800 relative h-48 flex flex-col justify-end overflow-hidden border border-gray-300 shadow-inner">
                            <div className="absolute top-4 right-4 flex items-center gap-2 text-xs text-gray-600 font-bold">
                                <span className="w-2 h-2 rounded-full bg-accent animate-pulse"></span> Live Feed
                            </div>
                            <p className="text-gray-700">[SYSTEM] Lead response: 4hr → 60sec</p>
                            <p className="text-gray-700 mt-2">[SYSTEM] Report generation: automated</p>
                            <p className="mt-2 text-gray-900 font-bold">[SYSTEM] Follow-up sequences: running<span className="inline-block w-2 h-4 bg-accent ml-1 animate-pulse align-middle"></span></p>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-100 border border-gray-300 rounded-[2rem] p-8 h-[400px] flex flex-col justify-between overflow-hidden relative group shadow-sm hover:shadow-md transition-shadow">
                        <h3 className="font-sans text-2xl font-bold text-gray-900">One System, One Price, No Scope Creep</h3>
                        <div className="mt-8">
                            ...
                            <div className="h-24 border border-dashed border-gray-400 rounded-xl flex items-center justify-center relative bg-gray-200">
                                <span className="font-drama italic text-2xl text-gray-500 group-hover:text-accent transition-colors duration-500">Scheduled.</span>
                            </div>
                        </div>
                    </div>
            ...
            <section className="protocol-wrapper py-32 relative bg-gray-200 overflow-hidden border-t border-gray-300">
                ...
                <div className="max-w-4xl mx-auto px-4 md:px-0 relative z-10">
                    {[
                        ...
                        { step: '02', title: 'BUILD', desc: 'One focused AI system mapped strictly to your workflow.', icon: '⚡' },
            ...
            <section className="py-20 bg-background relative z-10 border-t border-white/5 overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 md:px-20 mb-10 text-center">
                    <p className="font-mono text-sm font-bold text-gray-500 uppercase tracking-widest">Trusted by ambitious businesses</p>
                </div>
            ...
            <section className="py-32 px-4 md:px-20 bg-background relative z-10 border-t border-white/5 flex flex-col justify-center items-center">
                <h2 className="font-drama italic text-6xl text-center mb-12 text-white">Ready to Automate?</h2>
                <MagneticButton
                    ...
                    data-tally-open="Pd1MPe" data-tally-width="368" data-tally-emoji-text="👋" data-tally-emoji-animation="wave"
                >
                    <span className="flex items-center gap-4">Let's Talk <ArrowRight size={28} className="shrink-0" /></span>
                </MagneticButton>
            </section>
